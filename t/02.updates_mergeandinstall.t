...
my @tests = (
    {   count => 7,
        code  => sub {
            my $t = 'updates and mergeandinstall';
            ...
            like( $output, qr/adding \.testfile/, "$t - message in output" );
            ok( !-e "$repo2/.testfile", "$t - updated file is not there" );
            ...
            like( $output, qr/\.testfile/, "$t - message in output" );
            ok( -e "$repo2/.testfile", "$t - updated file is there" );
            ok( -l "$home2/.testfile", "$t - updated file is installed" );
            }
    },
);
